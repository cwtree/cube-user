...
public enum Resp {
	...
	USERNAME_PWD_ERROR(4001, "用户名密码错误"),

	CAPTCHA_CODE_ERROR(4002, "验证码错误"),

	SESSION_INVALID_ERROR(4003, "请登录"),

	FORCE_OFFLINE_ERROR(4004, "强制下线，请重新登录"),

	ACCESS_DENIED_ERROR(4005, "拒绝访问"),
